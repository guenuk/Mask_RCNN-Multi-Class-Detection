...
class ScrewDataset(utils.Dataset):
    ...
    def load_screw(self, dataset_dir, subset):
        """Load a subset of the Balloon dataset.
        dataset_dir: Root directory of the dataset.
        subset: Subset to load: train or val
        """
        # Add classes. We have only one class to add.
        self.add_class("screw", 1, "M")
        self.add_class("screw", 2, "I")
        self.add_class("screw", 3, "N")
        self.add_class("screw", 4, "K")
        self.add_class("screw", 5, "B")
